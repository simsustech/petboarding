  ...
  <q-layout view="lHh Lpr lFf">
    <div v-show="ready">
      ...
      <q-drawer
        ...
        @mouseover="debouncedToggleMiniState.cancel()"
        @hide="onDrawerHide"
      >
        <template #mini>
          <div
          ...
          >
            ...
            <div id="fabs" class="q-mb-md">
              <router-view name="fabs" :show-sticky="false" />
            </div>
      ...
      <q-page-container>
        <router-view />
        <router-view name="fabs" :show-sticky="true" />
      </q-page-container>
    </div>
  </q-layout>
</template>
...
import type { QDrawer, QuasarLanguage } from 'quasar'
