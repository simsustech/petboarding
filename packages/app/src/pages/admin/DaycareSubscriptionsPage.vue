...
>['$props']['onSubmit'] = async ({ data, done }) => {
  const result = useMutation('admin.createDaycareSubscription', {
    args: data,
    immediate: true
  })
...
const updateDaycareSubscription: InstanceType<
  typeof DaycareSubscriptionForm
>['$props']['onSubmit'] = async ({ data, done }) => {
  const result = useMutation('admin.updateDaycareSubscription', {
    args: data,
    immediate: true
  })
...
const openDeleteDaycareSubscriptionDialog = ({
  ...
  $q.dialog({
    ...
    const result = useMutation('admin.deleteDaycareSubscription', {
      args: {
        id: data.id!
      },
      immediate: true
