...
- Quality checks must always include running Playwright e2e tests (not just lint/format/build). Follow the full quality check sequence from AGENTS.md including Docker test environment setup and `pnpm run test:e2e`. Confidence: 0.80
